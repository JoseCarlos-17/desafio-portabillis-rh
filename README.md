...
Inicialmente eu pretendia fazer o front-end em Vue.js 3, aplicar a paginação na listagem de clientes,
...
Acho que o único diferencial que foi aplicado foi o design pattern "Query Object" para os filtros
